...
from lib.binance_alpha import (  # noqa: E402
    BinanceAlphaError,
    fetch_klines,
...
from lib.rules import build_discover_candidates, build_risk_report  # noqa: E402
...
def _save_compare_state(state: dict) -> None:
...
def build_watchlist_compare_snapshot(
    ...
    previous_state = _load_compare_state()
    ...
    if persist:
        _save_compare_state(next_state)
